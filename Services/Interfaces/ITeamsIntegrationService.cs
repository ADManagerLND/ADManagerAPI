...
{
    Task<string> CreateClassTeamAsync(string className, string classDescription, string classMailNickname,
    ...
    Task SetReadOnlyPermissionsForVisitorGroupAsync(string teamId, string channelId, string folderName,
