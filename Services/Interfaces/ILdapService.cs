...
namespace ADManagerAPI.Services.Interfaces
{
    public interface ILdapService : IDisposable
    {
        ...
        Task CreateUserAsync(Dictionary<string, string> attributes, string ouPath);
        ...
        Task<bool> CompareAndUpdateUserAsync(string samAccountName, Dictionary<string, string> newAttributes, string ouPath);

        void CreateGroup(string groupName, string ouDn, bool isSecurity = true, bool isGlobal = true, string? description = null, string? parentGroupDn = null);
